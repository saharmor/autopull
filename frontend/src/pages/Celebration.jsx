      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-primary-700 rounded-lg shadow-md p-5 mb-6 text-center">
          <div className="mb-3">
            ...
            <p className="text-primary-100 max-w-2xl mx-auto text-sm">
          ...
          {pullRequest && (
            <a 
              ...
              className="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md shadow-sm text-primary-700 bg-primary-100 hover:bg-primary-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all duration-150"
            >
              <svg className="-ml-0.5 mr-1.5 h-4 w-4 text-primary-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="bg-white shadow-md rounded-lg p-5 border border-neutral-100 mb-6">
          ...
          {pullRequest && (
            <div className="space-y-4">
              <div>
                <h4 className="text-base font-medium text-neutral-900 mb-1.5">Pull Request</h4>
                <div className="bg-neutral-50 rounded-lg p-3 border border-neutral-100">
                  <div className="flex items-start">
                    <div className="flex-shrink-0 mr-3">
                      <div className="h-10 w-10 rounded bg-primary-600 flex items-center justify-center text-white font-medium text-sm">
                        PR
                      </div>
                    </div>
                    <div>
                      <h5 className="text-base font-medium text-neutral-900 mb-0.5">
                        {pullRequest.title}
                      </h5>
              ...
              <div>
                <h4 className="text-base font-medium text-neutral-900 mb-1.5">Changes Made</h4>
                <div className="bg-neutral-50 rounded-lg p-3 border border-neutral-100">
                  <ul className="space-y-2">
                    {pullRequest.changed_files && pullRequest.changed_files.map((file, index) => (
                      <li key={index} className="flex items-start">
                        ...
                        <div>
                          <p className="text-xs font-medium text-neutral-900">{file.filename}</p>
              ...
              <div>
                <h4 className="text-base font-medium text-neutral-900 mb-1.5">Implementation Summary</h4>
                <div className="bg-neutral-50 rounded-lg p-3 border border-neutral-100">
        ...
        <div className="bg-white shadow-md rounded-lg p-5 border border-neutral-100">
          <h3 className="text-lg font-bold text-neutral-900 mb-3">
            What's Next?
          </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-neutral-50 rounded-lg p-4 border border-neutral-100">
              <div className="flex items-start mb-3">
                ...
                <div>
                  <h4 className="text-base font-medium text-neutral-900 mb-0.5">Review the Pull Request</h4>
              ...
              {pullRequest && (
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="btn btn-primary inline-flex items-center px-3 py-1.5 text-xs font-medium rounded-md shadow-sm transition-all duration-150 w-full justify-center"
                >
            ...
            <div className="bg-neutral-50 rounded-lg p-4 border border-neutral-100">
              <div className="flex items-start mb-3">
                ...
                <div>
                  <h4 className="text-base font-medium text-neutral-900 mb-0.5">Find More Issues</h4>
                  <p className="text-xs text-neutral-600">
